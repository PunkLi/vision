...
class ConstraintSet {
 public:
  ...
  float armor_svm(cv::Mat& img_roi);
	
  int armor_score_best(std::vector<ArmorInfo> &armors);

  float small_armor_svm(cv::Mat& img_roi);
